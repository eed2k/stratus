...
# =========================================================================
# =============================================================================
# QUAGGASKLIP Pi Zero W - low power optimization
#
...
if [ "$DISABLE_AVAHI" = "1" ]; then
  ...
  warn "avahi disabled: as3935Quaggasklip.local will stop resolving."
...
echo
echo "    python3 /home/quaggasklip/send_test_heartbeat.py"
