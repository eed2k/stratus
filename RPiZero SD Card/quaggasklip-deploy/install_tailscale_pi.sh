...
# =========================================================================
# =============================================================================
# QUAGGASKLIP lightning detector - admin-only remote access over Tailscale
#
# Run on the Pi:
...
TS_HOSTNAME="${TS_HOSTNAME:-quaggasklip-detector}"
...
Then, from an admin laptop that has joined the tailnet:
     ...
     tailscale ssh quaggasklip@${TS_HOSTNAME}
