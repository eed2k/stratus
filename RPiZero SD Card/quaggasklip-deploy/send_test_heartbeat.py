...
Useful options:
    ...
    python3 send_test_heartbeat.py --station QUAGGASKLIP  override the station id
...
def heartbeat_url(alert_url: str) -> str:
    ...
    https://panel/quaggasklip/api/v1/lightning -> https://panel/quaggasklip/api/v1/heartbeat
    """
    ...
    try:
        with urllib.request.urlopen(req, timeout=timeout) as resp:
            ...
            if 200 <= resp.status < 300:
                ...
                print()
                print("  https://adminpanel.stratusweather.co.za/quaggasklip/stations")
                return 0
            print()
        ...
        if e.code == 401:
            ...
            print("https://adminpanel.stratusweather.co.za/quaggasklip/api/v1/heartbeat")
        elif e.code == 422:
