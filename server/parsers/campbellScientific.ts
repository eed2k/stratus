...
export function mapToWeatherData(record: ParsedRecord, units?: string[], headers?: string[]): Record<string, number | null> {
  ...
  const fieldMappings: Record<string, string[]> = {
    temperature: ["AirTC", "AirTC_Avg", "Temp_C", "Temperature", "T_Avg", "Air_Temp", "Temp_Avg", "AirTemp_Avg", "AirTemp", "Temp", "Amb_Temp_Avg"],
    ...
    windSpeed: ["WS_ms", "WS_Avg", "WindSpd", "Wind_Speed", "WS_kph", "Wind_Spd_S_WVT", "WindSpeed_Avg", "WS_ms_Avg", "WS_ms_S_WVT", "WSpd_1_Avg", "WSpd_Avg", "WSpd_1_S_WVT", "WSpd_2_Avg"],
    windDirection: ["WD_Deg", "WD_Avg", "WindDir", "Wind_Dir", "Wind_Dir_D1_WVT", "WindDir_D1_WVT", "WindDir_Avg", "WD_Deg_Avg", "WDir_1_Avg", "WDir_Avg", "WDir_1_D1_WVT", "WDir_2_Avg"],
    ...
    batteryVoltage: ["BattV", "Batt_V", "Battery", "BattV_Avg", "BattV_Min", "Batt_volt_Min", "LoggerBattery_Avg", "LoggerBattery", "Batt_Volt_Avg"],
