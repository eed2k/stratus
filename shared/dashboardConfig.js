...
exports.DEFAULT_DASHBOARD_CONFIG = exports.UPDATE_PERIOD_OPTIONS = exports.DASHBOARD_CATEGORIES = void 0;
exports.getAllParameters = getAllParameters;
exports.getParameterById = getParameterById;
exports.getParametersByCategory = getParametersByCategory;
exports.DASHBOARD_CATEGORIES = [
    {
        id: 'atmospheric',
...
function getAllParameterIds() {
    return exports.DASHBOARD_CATEGORIES.flatMap(cat => cat.parameters.map(p => p.id));
}
...
function getAllParameters() {
    return exports.DASHBOARD_CATEGORIES.flatMap(cat => cat.parameters);
}
...
function getParametersByCategory(categoryId) {
    const category = exports.DASHBOARD_CATEGORIES.find(c => c.id === categoryId);
