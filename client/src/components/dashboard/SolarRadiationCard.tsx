      ...
      <CardContent>
        <div className="space-y-4">
          <div className="flex items-baseline gap-2">
            <span className="text-3xl font-bold text-black" style={{ fontFamily: 'Arial, Helvetica, sans-serif' }}>{currentRadiation.toFixed(1)}</span>
            <span className="text-sm font-bold text-black" style={{ fontFamily: 'Arial, Helvetica, sans-serif' }}>W/m²</span>
          </div>
