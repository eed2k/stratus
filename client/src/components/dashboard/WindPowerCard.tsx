      ...
      <CardContent>
        <div className="space-y-4">
          <div className="flex items-baseline gap-2">
            <span className="text-3xl font-normal">{currentPower.toFixed(1)}</span>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="rounded-lg bg-muted/50 p-3">
              ...
              <p className="text-lg font-normal">{gustPower.toFixed(1)} W/m²</p>
            </div>

            <div className="rounded-lg bg-muted/50 p-3">
              <p className="text-xs text-muted-foreground">Air Density</p>
              <p className="text-lg font-normal">{airDensity.toFixed(3)} kg/m³</p>
            </div>

            <div className="rounded-lg bg-muted/50 p-3">
              <p className="text-xs text-muted-foreground">Avg Speed (10m)</p>
              <p className="text-lg font-normal">{avgSpeed.toFixed(1)} km/h</p>
            </div>

            <div className="rounded-lg bg-muted/50 p-3">
              <p className="text-xs text-muted-foreground">Avg Power (10m)</p>
              <p className="text-lg font-normal">{avgPower.toFixed(1)} W/m²</p>
            </div>
          </div>
        </div>
      </CardContent>
