...
// serverless-src/functions/weather-data.ts
var weather_data_exports = {};
__export(weather_data_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(weather_data_exports);
...
async function fetchCampbellScientificData(ipAddress, port, username, password, dataTable) {
...
async function fetchRikaData(ipAddress, port, apiKey, apiEndpoint) {
