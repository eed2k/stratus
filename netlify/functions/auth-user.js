...
// serverless-src/functions/auth-user.ts
...
function getTokenFromEvent(event) {
  var _a, _b;
  const auth = (_a = event.headers) == null ? void 0 : _a.authorization;
  if (auth == null ? void 0 : auth.startsWith("Bearer ")) return auth.split(" ")[1];
  const cookie = ((_b = event.headers) == null ? void 0 : _b.cookie) || "";
