...
================================================================================
                  ...
                  AS3935 Antenna Calibration Utility
================================================================================
...
================================================================================
  ...
  Use this script to find the optimal tuning capacitor value for the AS3935
  antenna on the MikroE Thunder Click board. Run this before deploying the
  main lightning_detector.py script.

  The AS3935 antenna must resonate at 500 kHz (+/- 3.5%, i.e. 482.5 -
  517.5 kHz).  This script cycles through all 16 capacitor settings,
  measures the output frequency on the IRQ pin, and recommends the best
  setting.
